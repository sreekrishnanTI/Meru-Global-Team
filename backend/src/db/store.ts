...
export interface StoreSchema {
  ...
  testimonials: Array<{
    ...
    organization?: string;
    rating: number;
    category: string; // 'academic' | 'corporate' | 'youth' | 'exchange'
    program?: string;
    region?: string;
    photoPath?: string;
    displayOrder: number;
...
const DEFAULT_STORE: StoreSchema = {
  homepage: {
    ...
    aboutOverview: "Through our dedicated programs and global network, we bridge geographical and cultural gaps to bring hope and community transformation.",
    aboutMissionTitle: "Our Mission",
    aboutMissionText: "To mobilize, equip, and commission youth and professionals across nations to reach communities with sustainable hope.",
    aboutVisionTitle: "Our Vision",
    aboutVisionText: "A connected global community empowered by sustainable leadership, cultural understanding, and high-impact education.",
    donationTitle: "Help Meru reach more communities",
    donationSubtitle: "Your contribution supports global exchange access, youth leadership programs, and outreach for learners and communities who need opportunity most.",
    tickerItems: [
      { id: "1", label: "EXPANSION", date: "MAY 2026", text: "New regional partnership center established in Bogota, Colombia.", color: "blue", displayOrder: 1, active: true },
      { id: "2", label: "ADMISSIONS", date: "OPEN NOW", text: "Tokyo 2026 Global Academic Exchange applications are officially live.", color: "purple", displayOrder: 2, active: true },
      { id: "3", label: "PRESS", date: "FEATURED", text: "Dr. George Pappachen keynote scheduled for European Missions Congress.", color: "emerald", displayOrder: 3, active: true },
    ],
    stats: [
      { id: "1", target: 48, suffix: "+", label: "Global Programs", displayOrder: 1 },
      { id: "2", target: 12000, suffix: "+", label: "Delegates Trained", displayOrder: 2 },
      { id: "3", target: 35, suffix: "", label: "Nations Reached", displayOrder: 3 },
      { id: "4", target: 98, suffix: "%", label: "Impact Retention", displayOrder: 4 },
    ],
    values: [
      { id: "1", title: "Cultural Integrity", desc: "Respecting local heritage while nurturing cross-border leadership and mutual exchange.", icon: "Compass", displayOrder: 1 },
      { id: "2", title: "Empowered Leadership", desc: "Mobilizing youth and executives with verified frameworks and auditable standards.", icon: "ShieldCheck", displayOrder: 2 },
      { id: "3", title: "Global Fellowship", desc: "Connecting academic institutions, corporate sponsors, and community pioneers worldwide.", icon: "Users", displayOrder: 3 },
      { id: "4", title: "Sustainable Impact", desc: "Designing educational and missions programs that continue generating value for generations.", icon: "HeartHandshake", displayOrder: 4 },
    ],
  ...
  programs: [
    ...
    },
    {
      ...
      slug: "executive-corporate-governance",
      category: "corporate",
    ...
    },
    {
      ...
      location: "Global Virtual Accelerator",
      duration: "12 Weeks",
  ...
  testimonials: [
    ...
    },
    {
      ...
      author: "Lara Schmidt",
      role: "Exchange Scholar",
      organization: "Munich Academic Council",
      rating: 4,
      category: "academic",
      program: "exchange",
      region: "Europe",
    ...
    {
      id: "4",
      quote: "Reaching the unreached is not just a motto for Meru; they live it. Their scholarship support made it possible for 8 of our rural coordinators to study exchange.",
      author: "Amina Yusuf",
      role: "Admissions Lead",
      organization: "Lagos Civic Board",
      rating: 5,
      category: "academic",
      program: "youth",
      region: "Africa",
  ...
  videoTestimonials: [
    {
      ...
      role: "Tokyo Exchange Alumni",
      organization: "Class of 2025",
      details: "Tokyo Exchange Alumni, Class of 2025",
      duration: "3:42",
      videoUrl: "https://www.youtube.com/watch?v=dQw4w9WgXcQ",
      category: "academic",
      quote: "Living in Shinjuku and presenting research directly to Japanese academic faculties changed my worldview forever.",
      displayOrder: 1,
    },
    {
      id: "2",
      ...
      speaker: "David Vance",
      role: "VP of Talent",
      organization: "Novis Corp",
      details: "VP of Talent at Novis Corp",
      duration: "5:15",
      videoUrl: "https://www.youtube.com/watch?v=dQw4w9WgXcQ",
      category: "corporate",
      quote: "The governance models provided by Meru allowed us to overhaul our audit architecture in under six months.",
      displayOrder: 2,
    },
    {
      id: "3",
      title: "Cross-Border Academic Collaboration",
      speaker: "Dr. Elena Rostova",
      role: "Dean of International Studies",
      organization: "Munich University Partner",
      details: "Academic Board Advisor",
      duration: "4:10",
      videoUrl: "https://www.youtube.com/watch?v=dQw4w9WgXcQ",
      category: "academic",
      quote: "Meru's exchange curriculums are rigorous, fully credited, and bring tremendous global diversity to our classrooms.",
      displayOrder: 3,
    },
  ],
  historyMoments: [
    { id: "1", year: "2019", title: "First London Forum", tag: "Event", grad: "from-blue-400 to-indigo-500", description: "Convening initial delegates and international partners in London.", displayOrder: 1 },
    { id: "2", year: "2021", title: "Tokyo Seminars Group", tag: "Academic", grad: "from-purple-400 to-pink-500", description: "Inaugural research delegation to Shinjuku faculties.", displayOrder: 2 },
    { id: "3", year: "2022", title: "Bogota Office Opening", tag: "Expansion", grad: "from-emerald-400 to-teal-500", description: "Opening the first regional headquarters in South America.", displayOrder: 3 },
    { id: "4", year: "2023", title: "Corporate Review Board", tag: "Corporate", grad: "from-amber-400 to-orange-500", description: "Standardizing corporate ESG and compliance curricula.", displayOrder: 4 },
    { id: "5", year: "2025", title: "Global Youth Congress", tag: "Summit", grad: "from-sky-400 to-blue-600", description: "Bringing together 500 youth leaders across 35 nations.", displayOrder: 5 },
    { id: "6", year: "2026", title: "Africa Initiative Launch", tag: "Field", grad: "from-rose-400 to-purple-600", description: "Expanding grassroots missions and civic scholarships across West Africa.", displayOrder: 6 },
  ],
  historyMilestones: [
    {
      id: "1",
      year: "2010",
      title: "UPG Conference at ASCM",
    ...
    },
    {
      id: "3",
      year: "2011",
      title: "Doctor of ministry research project",
  ...
  contactSettings: {
    email: "contact@meruglobal.org",
    phone: "+1 (800) 555-MERU",
    officeHours: "Monday - Friday, 9am - 6pm EST",
    headquarters: "London, United Kingdom",
    branches: ["Tokyo, Japan", "Munich, Germany", "Bogota, Colombia", "Manila, Philippines"],
  },
  inquiries: [],
  media: [],
};
...
class DataStore {
    ...
    try {
      if (fs.existsSync(STORE_PATH)) {
        ...
        return {
          ...DEFAULT_STORE,
          ...parsed,
          homepage: { ...DEFAULT_STORE.homepage, ...(parsed.homepage || {}) },
          contactSettings: { ...DEFAULT_STORE.contactSettings, ...(parsed.contactSettings || {}) },
          programs: Array.isArray(parsed.programs) && parsed.programs.length > 0 ? parsed.programs : DEFAULT_STORE.programs,
          testimonials: Array.isArray(parsed.testimonials) && parsed.testimonials.length > 0 ? parsed.testimonials : DEFAULT_STORE.testimonials,
          videoTestimonials: Array.isArray(parsed.videoTestimonials) && parsed.videoTestimonials.length > 0 ? parsed.videoTestimonials : DEFAULT_STORE.videoTestimonials,
          historyMoments: Array.isArray(parsed.historyMoments) && parsed.historyMoments.length > 0 ? parsed.historyMoments : DEFAULT_STORE.historyMoments,
          historyMilestones: Array.isArray(parsed.historyMilestones) && parsed.historyMilestones.length > 0 ? parsed.historyMilestones : DEFAULT_STORE.historyMilestones,
          newsArticles: Array.isArray(parsed.newsArticles) && parsed.newsArticles.length > 0 ? parsed.newsArticles : DEFAULT_STORE.newsArticles,
          newsEvents: Array.isArray(parsed.newsEvents) && parsed.newsEvents.length > 0 ? parsed.newsEvents : DEFAULT_STORE.newsEvents,
        };
      }
    } catch (e: any) {
      console.warn("Store read error, using default store:", e.message);
    }
  ...
  public save(data?: Partial<StoreSchema>): void {
    try {
      this.ensureDataDir();
      if (data) {
      ...
      console.error("Failed to save store to disk:", e.message);
    }
  }
